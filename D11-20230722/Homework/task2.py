#This task will explain to analyses the data to find the month with min and max gold rate along with the total cost of each jewel for the months with the min and max gold rates.
...
for jwel_data in monthly_jwel_rate:
    ...
    #print(str(min_rate),min_rate_month)
    if gold_rate >= max_rate:
        max_rate = gold_rate
        max_rate_month = month
    #print(str(max_rate),max_rate_month)
#print(str(min_rate),min_rate_month)
#print(str(max_rate),max_rate_month)
