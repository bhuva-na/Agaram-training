...
function valueAssign(id){
    ...
    $.ajax({
        ...
        success:function(responce){
           ...
           let github=`<a href=${ArrayDetails.github}></a>`
                    $("#name").html(name)
                    // $("#email").html(Email)
                    $("#email").html(Email)
                    ...
                    let date=`<p>DATE:${ArrayDetails.date}</p>`
  ...
  $("#LanguageKnow").html(laglist)
                ...
                let personal=""
                personal=personal+`<p>Father Name:${personal_Details.Father_name}</p>
                <p>Mother Name:${personal_Details.mother_name}</p>
                <p>Gender:${personal_Details.Gender}</p>
